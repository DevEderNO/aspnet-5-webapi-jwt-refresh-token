...
namespace RefreshTokenAuth.Services
{
  public static class TokenService
  {
    ...
    public static ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
    {
      ...
      if (securityToken is not JwtSecurityToken tokenSecurity || !tokenSecurity.Header.Alg.Equals(SecurityAlgorithms.HmacSha256, StringComparison.InvariantCultureIgnoreCase))
